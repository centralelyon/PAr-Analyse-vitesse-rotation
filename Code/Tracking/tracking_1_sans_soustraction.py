...
while True:
    ...
    scale_percent = 25 # percent of original size !!! change le calibrage notamment sur la taille de la balle en pxl
    ...
    if len(cnts):
        ...
        if radius <10 and not (center is None): #j'ai enlevé la condition "radius >3"
